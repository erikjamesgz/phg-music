...
const LANGUAGE_STORAGE_KEY = "celadon_language";
let currentLanguage = utils_storage.getStorage(LANGUAGE_STORAGE_KEY) || LanguageType.ZH_CN;
const languagePacks = {
  // 简体中文
  [LanguageType.ZH_CN]: {
    // 通用
    ...
    player: {
      ...
      lyrics: "歌词",
      no_lyrics: "暂无歌词",
      loading_lyrics: "加载歌词中...",
      play_quality: "播放音质",
      standard_quality: "标准音质",
      high_quality: "高音质",
      super_quality: "超高音质",
      lossless_quality: "无损音质",
      current_playlist: "当前播放列表",
      clear_playlist: "清空播放列表",
      save_as_playlist: "保存为歌单",
      song_info: "歌曲信息",
      album_info: "专辑信息",
      artist_info: "歌手信息",
      set_as_ringtone: "设为铃声",
      sleep_timer: "睡眠定时",
      sleep_timer_off: "关闭睡眠定时",
      sleep_timer_on: "睡眠定时已开启，将在{0}分钟后停止播放",
      equalizer: "均衡器",
      speed: "播放速度",
      normal_speed: "正常",
      speed_0_75: "0.75x",
    ...
    playlist: {
      ...
      play_all: "播放全部",
      add_to_playlist: "收藏",
      remove_from_playlist: "取消收藏",
      share: "分享",
      comment: "评论",
      download: "下载",
      edit: "编辑",
      delete: "删除",
      delete_confirm: "确定要删除该歌单吗？",
      create_playlist: "创建歌单",
      edit_playlist: "编辑歌单",
      playlist_name: "歌单名称",
      playlist_cover: "歌单封面",
      playlist_description: "歌单简介",
      playlist_tags: "歌单标签",
      playlist_privacy: "歌单隐私",
      public: "公开",
      private: "私密",
      save_success: "保存成功",
      create_success: "创建成功",
      ...
      add_songs: "添加歌曲",
      remove_songs: "移除歌曲",
      selected_count: "已选择{0}首歌曲",
      add_to_playlist_success: "已添加到歌单",
      remove_from_playlist_success: "已从歌单中移除",
    ...
    comment: {
      ...
      reply_to: "回复 {0}",
      delete_confirm: "确定要删除该评论吗？",
      delete_success: "删除成功",
      like_success: "点赞成功",
      cancel_like_success: "取消点赞成功",
    ...
    settings: {
      ...
      clear_search_history_success: "清除搜索历史成功",
      clear_search_history_confirm: "确定要清除搜索历史吗？",
      clear_play_history: "清除播放历史",
      clear_play_history_success: "清除播放历史成功",
      clear_play_history_confirm: "确定要清除播放历史吗？",
      theme_light: "浅色模式",
      theme_dark: "深色模式",
      theme_system: "跟随系统",
      language_zh_cn: "简体中文",
      ...
      other_feedback: "其他反馈",
      please_select_feedback_type: "请选择反馈类型",
      please_input_feedback_content: "请输入反馈内容",
      contact_optional: "联系方式（选填）",
      // 新增字段
      personalization: "个性化",
      celadonTheme: "青釉主题",
      darkMode: "深色模式",
    ...
    profile: {
      ...
      please_select_birthday: "请选择生日",
      please_select_region: "请选择地区",
      please_input_signature: "请输入个性签名",
      nickname_length_limit: "昵称长度不能超过20个字符",
      signature_length_limit: "个性签名长度不能超过50个字符"
    }
  },
  // 英文（美国）
  [LanguageType.EN_US]: {
    ...
    discover: {
      ...
      personalized_playlist: "Recommended Playlists",
      new_songs: "New Songs",
      new_albums: "New Albums",
      top_playlist: "Top Playlists",
    ...
    player: {
      ...
      play_quality: "Play Quality",
      standard_quality: "Standard Quality",
      high_quality: "High Quality",
      super_quality: "Super Quality",
      ...
      sleep_timer_on: "Sleep timer is on, playback will stop in {0} minutes",
      equalizer: "Equalizer",
    ...
    playlist: {
      ...
      songs_count: "{0} songs",
      play_count: "{0} plays",
      create_time: "Created: {0}",
      update_time: "Updated: {0}",
      creator: "Creator: {0}",
      description: "Description",
      no_description: "No description",
      play_all: "Play All",
      add_to_playlist: "Collect",
      remove_from_playlist: "Uncollect",
      share: "Share",
      comment: "Comment",
      download: "Download",
      edit: "Edit",
      ...
      add_songs: "Add Songs",
      remove_songs: "Remove Songs",
      selected_count: "{0} songs selected",
      add_to_playlist_success: "Added to playlist",
      remove_from_playlist_success: "Removed from playlist",
      collect_success: "Collected successfully",
      cancel_collect_success: "Uncollected successfully"
    },
    // 歌手详情
    artist: {
      title: "Artist",
      ...
      cancel_follow_success: "Unfollowed successfully",
      fans_count: "{0} followers",
      works_count: "{0} works"
    },
    // 专辑详情
    album: {
    ...
    comment: {
      ...
      cancel_like_success: "Unliked successfully",
    ...
    settings: {
      ...
      clear_search_history_success: "Search history cleared successfully",
      clear_search_history_confirm: "Are you sure you want to clear the search history?",
      clear_play_history: "Clear Play History",
      clear_play_history_success: "Play history cleared successfully",
      ...
      wifi_only: "Play on WiFi Only",
      wifi_only_download: "Download on WiFi Only",
      sleep_timer: "Sleep Timer",
      equalizer: "Equalizer",
      notification_settings: "Notification Settings",
      new_message: "New Message Notification",
      new_followers: "New Follower Notification",
      new_comments: "New Comment Notification",
      ...
      please_input_feedback_content: "Please enter feedback content",
      contact_optional: "Contact Information (Optional)",
      // 新增字段
      settings: "Settings",
      personalization: "Personalization",
      celadonTheme: "Celadon Theme",
      darkMode: "Dark Mode",
      followSystem: "Follow System",
      playbackSettings: "Playback Settings",
      audioQuality: "Audio Quality",
      affectsDataUsage: "Affects Data Usage",
      qualityLow: "Low Quality",
      qualityStandard: "Standard Quality",
      qualityHigh: "High Quality",
      qualityLossless: "Lossless Quality",
      qualityAuto: "Auto Quality",
      auto: "Auto",
      autoplay: "Autoplay",
      wifiPlaybackOnly: "WiFi Playback Only",
      downloadAndCache: "Download and Cache",
      wifiDownloadOnly: "WiFi Download Only",
      cacheManagement: "Cache Management",
      downloadLocation: "Download Location",
      internalStorage: "Internal Storage",
      sourceManagement: "Source Management",
      sourceList: "Source List",
      sourceListDesc: "Manage installed music sources",
      aboutCeladonMusic: "About Celadon Music",
      userAgreement: "User Agreement",
      helpAndFeedback: "Help and Feedback",
      checkForUpdates: "Check for Updates",
      selectQuality: "Select Quality",
      selectLanguage: "Select Language",
      qualityAutoDesc: "Automatically select best quality based on network",
    ...
    app: {
      name: "Celadon Music",
      slogan: "Discover the Beauty of Music"
    },
    // 个人资料
    profile: {
      title: "Profile",
      ...
      please_input_nickname: "Please enter nickname",
      ...
      please_input_signature: "Please enter signature",
      nickname_length_limit: "Nickname cannot exceed 20 characters",
      signature_length_limit: "Signature cannot exceed 50 characters"
    }
  }
};
function getLanguagePack() {
  return languagePacks[currentLanguage] || languagePacks[LanguageType.ZH_CN];
}
function t(key, params = []) {
  const languagePack = getLanguagePack();
  const keys = key.split(".");
  const module2 = languagePack[keys[0]];
  if (!module2) {
    console.warn(`未找到翻译模块: ${keys[0]}`);
    return key;
  }
  const text = module2[keys[1]];
  if (!text) {
  ...
  if (params.length > 0) {
    return text.replace(/\{(\d+)\}/g, (match, index) => {
      return params[index] !== void 0 ? params[index] : match;
    });
  }
  return text;
}
