...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const checkTagScrollStatus = () => {
      setTimeout(() => {
        canScrollTagRight.value = boardList.value.length > 5;
        console.log("[排行榜] 检测标签滚动状态 - 是否有更多:", canScrollTagRight.value, "标签数量:", boardList.value.length);
      }, 100);
    };
    ...
    const onTagScroll = (e) => {
      ...
      console.log("[Rank-Tag] onScroll 触发 - scrollLeft:", scrollLeft, "scrollWidth:", scrollWidth, "clientWidth:", clientWidth);
    ...
    const updateTagButtonState = (scrollLeft, scrollWidth, clientWidth) => {
      if (!scrollWidth || !clientWidth || clientWidth <= 0) {
        console.log("[Rank-Tag] 尺寸信息不完整 - scrollWidth:", scrollWidth, "clientWidth:", clientWidth);
        return;
      }
      const canLeft = scrollLeft > 1;
      const canRight = scrollLeft < scrollWidth - clientWidth - 1;
      console.log(
        "[Rank-Tag] 更新按钮状态 - canLeft:",
        canLeft,
        "canRight:",
        canRight,
        "当前scrollLeft:",
    ...
    return (_ctx, _cache) => {
      ...
      return common_vendor.e({
        ...
        e: common_vendor.o(($event) => showSourcePicker.value = true, "6a"),
        ...
        h: common_vendor.o(onTagScroll, "48"),
        ...
        m: common_vendor.t(loadError.value),
        n: common_vendor.o(retryLoad, "56")
      } : {}, {
        o: songList.value.length > 0
      }, songList.value.length > 0 ? {
        p: common_vendor.f(songList.value, (song, index, i0) => {
          return common_vendor.e({
        ...
        B: common_vendor.o(($event) => showSourcePicker.value = false, "ea"),
        ...
        E: common_vendor.o(($event) => showSourcePicker.value = false, "bc")
      }) : {}, {
        F: showMenu.value
      }, showMenu.value ? {
        G: common_vendor.t((_a = selectedSong.value) == null ? void 0 : _a.name),
        H: common_vendor.t(formatArtists(selectedSong.value)),
        I: common_vendor.p({
          name: "play",
          size: "18",
          color: "#00d7cd"
        ...
        P: common_vendor.o(collectSong, "f8"),
        Q: common_vendor.o(closeMenu, "26"),
        R: common_vendor.o(() => {
        }, "29"),
        S: common_vendor.o(closeMenu, "f8")
      } : {}, {
        T: showMiniPlayer.value && !isTablet.value
      }, showMiniPlayer.value && !isTablet.value ? {} : {}, {
        U: darkMode.value ? 1 : "",
        V: isTablet.value ? 1 : ""
      });
    };
